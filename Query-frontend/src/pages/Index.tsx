        ...
        <section id="features" className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-gray-50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Feature 8 */}
              <div className="group relative bg-white rounded-3xl p-8 border border-gray-200 hover:border-pink-300 hover:shadow-2xl transition-all duration-500 overflow-hidden">
                ...
                <div className="relative">
                  <div className="w-14 h-14 bg-gradient-to-br from-pink-100 to-purple-100 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                    <MessageSquare className="w-7 h-7 text-pink-600" strokeWidth={2.5} />
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Daily Tips</h3>
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Gets "Tip of the Day" notification with best practices for performance,indexing and query optimization.
                  </p>
